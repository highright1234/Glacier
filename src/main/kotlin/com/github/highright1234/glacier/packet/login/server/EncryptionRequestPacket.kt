package com.github.highright1234.glacier.packet.login.server
...
data class EncryptionRequestPacket(
    ...
    override fun read(buf: ByteBuf, version: Int) {
        ...
        val publicKeyLength: Int = readVarInt(buf).value
        publicKey = buf.readBytes(publicKeyLength).array()
        val verifyTokenLength: Int = readVarInt(buf).value
